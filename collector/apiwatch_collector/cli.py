...
def _request_json(url: str, method: str = "GET") -> tuple[int, dict | None, str | None]:
...
def _cmd_doctor(args: argparse.Namespace) -> int:
    ...
    status, summary, error = _request_json(f"{base}/summary")
...
def _cmd_clear(args: argparse.Namespace) -> int:
    ...
    status, body, error = _request_json(url, method="DELETE")
